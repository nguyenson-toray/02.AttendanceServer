                ...
                if len(self.templates) < 3:
                    if not self.templates or self.zkfp2.DBMatch(self.templates[-1], tmp) > 0: # check if the finger is the same
                        ...
                        if len(self.templates) == 3:
                            ...
                            # decodeA=self.zkfp2.Blob2Base64String(self.templates[0])
                            template_string = base64.b64encode(regTemp).decode('utf-8')
                            print("Fingerprint template (Base64):", template_string)
                            # print(type(decodeA))
                            # print(decodeA)
